...
export default function Navbar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <a href="/" className="flex items-center gap-2.5 font-black text-xl tracking-tight no-underline"
        style={{ color: '#1B6DEA' }}>
        <div className="w-9 h-9 rounded-[10px] flex items-center justify-center flex-shrink-0"
          style={{ background: 'linear-gradient(135deg, #1B6DEA, #0A2240)' }}>
      ...
      <div className="flex gap-2.5 items-center">
        ...
        <motion.a
          href="#koc"
          className="px-5 py-2 rounded-full text-white text-sm font-bold flex items-center gap-1.5"
          style={{
            background: '#1B6DEA',
            boxShadow: '0 4px 14px rgba(27,109,234,0.35)',
            textDecoration: 'none',
          }}
