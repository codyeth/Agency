...
export default function CTABanner() {
  return (
    <section className="relative overflow-hidden text-center"
      style={{ background: 'linear-gradient(155deg, #2463EB 0%, #0A2240 100%)', paddingTop: '80px', paddingBottom: '125px', paddingLeft: '40px', paddingRight: '40px' }}>
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto">
        ...
        >
          <motion.a href="#contact"
            className="inline-flex items-center gap-2 h-12 px-9 bg-white font-semibold text-base rounded-[64px]"
          ...
          <motion.a href="#koc"
            className="inline-flex items-center gap-2 h-12 px-9 border rounded-[64px] font-semibold text-base text-white"
